    ...
    after_render : () => {
        ...
        .addEventListener('submit',async(e) =>{
            ...
            if(data.error){
                ...
                // setUserInfo(data);
                // redirectUserS();
                location.hash = "/show_instructor_message";
            }
        });
    },
    render : async () => {
        return `
            ...
            <div class="mdk-header-layout js-mdk-header-layout">
                ...
                <h2 style="text-align:center;">Instructor Register</h2>
                <div class="container page__container" id='login_margin'>
                            <form id="register-form" class="col-md-5 p-0 mx-auto">
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="text-right"><a href="/#/signup" class="small">Are you a student?</a></p>
                                </div>
                                <div class="text-center">
                                    <button class="btn btn-primary">Schedule an meeting</button>
                                </div>
                            </form>
                        </div>
                    </div>
