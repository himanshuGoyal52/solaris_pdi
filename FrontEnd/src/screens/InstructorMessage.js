        ...
        <div class="mdk-header-layout js-mdk-header-layout">
            ...
            <!-- // END Header -->
                    ...
                    <div style="display:flex; align-items:center; justify-content:center; margin:2rem; height:70vh;">
                        <div style="width:45%; ">
                            <img style="width:44rem;" src="assets/meeting.png" alt="" />
                        </div>
                        <div style="width:45%;">
                            <h2 style="text-align:center;">About Us</h2>                        
                            <p> Hi, thanks for contacting us. We've received your email id and appreciate your getting in touch through a meeting soon. <br> please regularly check your inbox!
                            </p>
                        </div>
                    </div>
                    <!-- end about container -->
